...
from langchain_openai import ChatOpenAI, OpenAIEmbeddings as _BaseOpenAIEmbeddings
...
if not api_key or not api_key.startswith("sk-"):
    st.error("❌ OpenAI API key not found. Add it in .env or Streamlit Secrets.")
    st.stop()
...
if process_url_clicked:
    try:
        ...
        embeddings = SafeOpenAIEmbeddings(api_key=api_key, model="text-embedding-3-small")
